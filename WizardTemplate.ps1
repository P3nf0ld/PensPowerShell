...
<Window
    ...
    <Grid Margin="0" Background="#fff">
        ...
        <TabControl Name="wizardPages" HorizontalAlignment="Left" Height="472" Margin="10,-5,0,0" Grid.Row="1" VerticalAlignment="Top" Width="760" Grid.ColumnSpan="2" Grid.RowSpan="3">
            <TabItem Name="TabStep1" Header="Step 1">
                <Grid Background="#fff" Margin="0,-1,0,1">
                    <Grid.ColumnDefinitions>
                    ...
                    <TextBlock x:Name="txtCSVInputFile" HorizontalAlignment="Left" Margin="0,1,0,0" Grid.Row="1" TextWrapping="Wrap" Text="Select CSV Input File:" VerticalAlignment="Center" Height="24" Width="150" TextAlignment="Right" LineHeight="12"/>
                    <TextBlock x:Name="txtDocFoler" HorizontalAlignment="Left" Margin="0,6,0,5" Grid.Row="2" TextWrapping="Wrap" Text="Select Folder to Import:" VerticalAlignment="Center" Height="24" Width="150" TextAlignment="Right" LineHeight="12"/>
                    <TextBox x:Name="CSVInputFile" Grid.Column="1" HorizontalAlignment="Left" Height="23" Margin="5,5,0,0" Grid.Row="1" TextWrapping="Wrap" VerticalAlignment="Top" Width="450"/>
                    <TextBox x:Name="DocFolder" Grid.Column="1" HorizontalAlignment="Left" Height="23" Margin="5,5,0,0" Grid.Row="2" TextWrapping="Wrap" VerticalAlignment="Top" Width="450"/>
                    <Button x:Name="selectFileBtn" Content="Browse" Grid.Column="1" HorizontalAlignment="Left" Margin="460,6,0,0" Grid.Row="1" VerticalAlignment="Top" Width="74"/>
                    <Button x:Name="SelectDocumentRootFolderBtn" Content="Browse" Grid.Column="1" HorizontalAlignment="Left" Margin="460,6,0,0" Grid.Row="2" VerticalAlignment="Top" Width="74"/>
            ...
            <TabItem Name="TabStep2" Header="Step 2" IsEnabled="False">
                <Grid Background="#fff">
                    ...
                    <TextBlock x:Name="testTextChanged2" HorizontalAlignment="Left" Margin="103,20,0,0" TextWrapping="Wrap" VerticalAlignment="Top"/>
                </Grid>
            </TabItem>
            <TabItem Name="TabStep3" Header="Step 3" IsEnabled="False">
                <Grid Background="#fff">
                    ...
                    <TextBlock x:Name="testTextChanged3" HorizontalAlignment="Left" Margin="103,20,0,0" TextWrapping="Wrap" VerticalAlignment="Top"/>
                </Grid>
            </TabItem>
            <TabItem Name="TabStep4" Header="Step 4" IsEnabled="False">
                <Grid Background="#fff">
                    ...
                    <TextBlock x:Name="testTextChanged4" HorizontalAlignment="Left" Margin="103,20,0,0" TextWrapping="Wrap" VerticalAlignment="Top"/>
                </Grid>
            </TabItem>
...
function Validate-WizardPage
{
  ...
  if($WizardPage -eq 0)
  {
    ...
    if($window.CSVInputFile.Text -and $window.DocFolder.Text)
    {
...
$window = Convert-XAMLtoWindow -XAML $xaml -NamedElement 'ButBack', 'ButCancel', 'ButFinish', 'ButNext', 'logo', 'TabStep1', 'TabStep2', 'TabStep3', 'TabStep4', 'TabStep5', 'CSVInputFile', 'testTextChanged1','TestStep2', 'testTextChanged2','TestStep3', 'testTextChanged3', 'TestStep4', 'testTextChanged4','wizardPages','selectFileBtn','SelectDocumentRootFolderBtn','txtCSVInputFile','txtDocFoler','CSVInputFile','DocFolder' -PassThru
#endregion
...
$window.CSVInputFile.add_TextChanged{
...
$window.selectFileBtn.add_Click{
  ...
  try{
    ...
    $file = Select-FileDialog -Title "Select a file" -Directory "C:\" -Filter "CSV (*.csv)| *.csv"
    $window.CSVInputFile.Text = $file
